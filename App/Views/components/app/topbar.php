        ...
        <nav class="navbar">
          ...
          <div class="d-flex">
            ...
            <a href="https://www.wrraptheme.com/templates/luno/index.html" class="brand-icon d-flex align-items-center mx-2 mx-sm-3 text-primary">
              ...
              <img src="/Public/assets/logo/Logo.png" alt="" width="100">
            </a>
          </div>
          <!-- start: search area -->
              ...
              <div class="card shadow rounded-4 search-result slidedown">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap align-items-start mt-2 mb-4">
                    <a class="small rounded py-1 px-2 m-1 fw-normal bg-primary text-white" href="index.html#">HRMS Admin</a>
                    <a class="small rounded py-1 px-2 m-1 fw-normal bg-secondary text-white" href="index.html#">Hospital Admin</a>
                    ...
                    <a class="small rounded py-1 px-2 m-1 fw-normal bg-danger text-white" href="index.html#">University Admin</a>
                  </div>
