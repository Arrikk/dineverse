<div class="row g-3 row-deck">
    ...
    <div class="col-lg-8 col-md-12">
        <div class="card">
            <div class="card-header">
                <h6 class="card-title m-0">Salary Statistics</h6>
            ...
            <div class="card-body">
                ...
                <div id="apex-SalaryStatistics"></div>
            </div>
        </div> <!-- .card end -->
    </div>
    <div class="col-lg-4 col-md-12">
        <div class="card">
            <div class="card-header">
                <h6 class="card-title m-0">Income Analysis</h6>
                <div class="dropdown morphing scale-left">
                    <a href="index.html#" class="card-fullscreen" data-bs-toggle="tooltip" title="Card Full-Screen"><i class="icon-size-fullscreen"></i></a>
                    <a href="index.html#" class="more-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                    <ul class="dropdown-menu shadow border-0 p-2">
    ...
    <div class="col-xxl-4 col-xl-5 col-lg-4 col-md-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                <h6 class="card-title m-0">Active Employee</h6>
                <div class="dropdown morphing scale-left">
                    <a href="index.html#" class="card-fullscreen" data-bs-toggle="tooltip" title="Card Full-Screen"><i class="icon-size-fullscreen"></i></a>
                    <a href="index.html#" class="more-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                    <ul class="dropdown-menu shadow border-0 p-2">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs tab-page-toolbar rounded-pill d-inline-flex">
                    <li class="nav-item"><a class="nav-link rounded-pill border-0 active" data-bs-toggle="tab" href="index.html#EmployeePerformance">Employee Performance</a></li>
                    <li class="nav-item"><a class="nav-link rounded-pill border-0" data-bs-toggle="tab" href="index.html#NewEmployee">New Employee</a></li>
                </ul>
            </div>
            <!-- Tab panes -->
                ...
                <div role="tabpanel" class="tab-pane in active" id="EmployeePerformance">
                    <div class="table-responsive">
                        <table id="myDataTable" class="table card-table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="/Public/assets/img/xs/avatar1.jpg" class="avatar sm rounded-circle" alt=""></td>
                                    <td>Marshall Nichols</td>
                                    <td><span>UI UX Designer</span></td>
                                    <td><span class="badge bg-success">Good</span></td>
                                </tr>
                                <tr>
                                    <td><img src="/Public/assets/img/xs/avatar2.jpg" class="avatar sm rounded-circle" alt=""></td>
                                    <td>Susie Willis</td>
                                    <td><span>Designer</span></td>
                                    <td><span class="badge bg-warning">Average</span></td>
                                </tr>
                                <tr>
                                    <td><img src="/Public/assets/img/xs/avatar3.jpg" class="avatar sm rounded-circle" alt=""></td>
                                    <td>Francisco Vasquez</td>
                                    <td><span>Team Leader</span></td>
                                    <td><span class="badge bg-primary">Excellent</span></td>
                                </tr>
                                <tr>
                                    <td><img src="/Public/assets/img/xs/avatar4.jpg" class="avatar sm rounded-circle" alt=""></td>
                                    <td>Erin Gonzales</td>
                                    <td><span>Android Developer</span></td>
                                    <td><span class="badge bg-danger">Weak</span></td>
                                </tr>
                                <tr>
                                    <td><img src="/Public/assets/img/xs/avatar5.jpg" class="avatar sm rounded-circle" alt=""></td>
                                    <td>Ava Alexander</td>
                                    <td><span>UI UX Designer</span></td>
                                    <td><span class="badge bg-success">Good</span></td>
                                </tr>
